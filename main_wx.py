...
class mainFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        btn_mea = wx.Button(self, -1, u'更改路径', pos=(350, 50), size=(100, 25))
        btn_meb = wx.Button(self, -1, u'文本检测', pos=(350, 80), size=(100, 25))
        btn_close = wx.Button(self, -1, u'文本识别', pos=(350, 110), size=(100, 25))
        btn_bat = wx.Button(self, -1, u'批量处理', pos=(350, 140), size=(100, 25))
        ...
        btn_bat.Bind(wx.EVT_LEFT_DCLICK,self.OnOpen)
